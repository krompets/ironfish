...
const { NoteEncrypted, NoteBuilder, Note, TransactionPosted, Transaction, generateKey, generateNewPublicAddress, mineHeaderBatch, FoundBlockResult, ThreadPoolHandler } = nativeBinding
